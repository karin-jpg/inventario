...
<div class="wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">ATENDIMENTOS DIÁRIOS</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="quantidadeAtendimentosPorDiaPlanilha.php">Página inicial</a></li>
              <li class="breadcrumb-item active">Relatórios</li>
              <li class="breadcrumb-item active">Atendimentos diários</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
...
function planilha(){
	...
	<?php
	echo 'window.open("planilhas/atendimentosDiariosPlanilha.php?dt_inicial='.$dt_inicial.'&dt_final='.$dt_final.'");';
	?>
}
