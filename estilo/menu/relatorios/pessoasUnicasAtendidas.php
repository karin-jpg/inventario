...
<div class="wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">PESSOAS ÚNICAS ATENDIDAS</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Página inicial</a></li>
              <li class="breadcrumb-item active">Relatórios</li>
              <li class="breadcrumb-item active">Pessoas únicas atendidas</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
...
function planilha(){
	...
	<?php
	echo 'window.open("planilhas/pessoasUnicasAtendidasPlanilha.php?dt_inicial='.$dt_inicial.'&dt_final='.$dt_final.'&bairro='.$_POST[bairro].'");';
	?>
}
