...
$pa = $principio_ativo->listar();
  ...
  if($_POST['acao'] == "novo"){
    if($principio_ativo->salvar($_POST['pa']))
    {
      $s = 1;
    }else {
      $s = 0;
  ...
  if($_POST['acao'] == "editar"){
    if($principio_ativo->editar($_POST['id'], $_POST['pa']))
      {
        $s = 1;
      }else {
        $s = 0;
   ...
   <!-- Content Header (Page header) -->
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">PRINCÍPIO ATIVO</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Página inicial</a></li>
              <li class="breadcrumb-item active">Princípio Ativo</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="card-header col-sm-2">
          ...
          echo
          '<tr>
            <td id = "pa_'.$pa[$i]['id'].'">'.$pa[$i]['nome'].'</td>
            <td><input type="checkbox" name="selecionados[]" id = "'.$pa[$i]['id'].'"></td>
          </tr>';
          }
          ?>
                  </tbody>
          ...
          <div class="modal-content">
            <div class="modal-body">
              ...
              <div class="card-header">
                <h3 class="card-title">Novo PA</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" id = "form" method="post" action="pa.php">
                <div class="card-body">
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-body">
              ...
              <div class="card-header">
                <h3 class="card-title">Editar PA</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" id = "form" method="post" action="pa.php">
                <div class="card-body">
                  <div class="form-group">
                    <label>Princípio Ativo</label>
                    <input type="text" class="form-control" name="pa" id = "pa-edit">
                  </div>
...
function alterarCad(){
  ...
  var pa = "pa_"+cadastro;
  var valor_pa = document.getElementById(pa).innerHTML;
  var id = cadastro;
    $("#modal-edit").modal({
    show: true
  });
        $("#pa-edit").val(valor_pa);
