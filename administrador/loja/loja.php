...
if($acao == 'novo'){
  ...
  $sucesso = $loja->salvar($_POST['nome']);
  if($sucesso){
    $msg = "Loja inserida!";
  }else{
    $msg = "Ocorreu um erro ao inserir a loja, caso o mesmo persista contate o suporte";
  }
}

if($acao == 'editar'){
  $sucesso = $loja->editar($_POST['id-loja'], $_POST['nome']);
  if($sucesso){
    $msg = "Loja atualizada!";
  }else{
    $msg = "Ocorreu um erro ao atualizar a loja, caso o mesmo persista contate o suporte";
  }
}
$lojas = $loja->listar();
?>
        ...
        <div class="row">
          <div class="col-12">
            ...
            <div class="card">
              ...
              <div class="card-body">
                <table id="tableLoja" class="table table-bordered table-striped">
                  <thead>
                    <tr>
                      <th>Nome</th>
                    </tr>
          ...
          <div class="modal-content">
            <div class="modal-body">
              ...
              <div class="card-header">
                <h3 class="card-title" id="titulo">Nova Loja</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" id = "form" method="post" action="loja.php">
              <input type="hidden" name="acao" id = "acao" value = "">
              <input type="hidden" name="id-loja" id = "id-loja" value = "">
                <div class="card-body">
...
<!-- page script -->
<script>
document.querySelector("#tableLoja").addEventListener("dblclick", function(event){
  ...
  $("#modal-default").modal({
    show: true
      ...
      document.querySelector('#id-loja').value = event.target.parentNode.id;
...
<script>
    ...
    var validacoes = [
        {
            nome: 'nome',
            valido: nomeValido,
            mensagem: 'Nome da loja não pode estar vazio!'
        }
    ]
  ...
  function clearForm(){
    ...
    document.querySelector('#titulo').innerText = 'Nova Loja';
