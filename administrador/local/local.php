...
if($acao == 'novo'){
  ...
  if($sucesso){
    ...
    $msg = "Ocorreu um erro ao inserir a local, caso o mesmo persista contate o suporte";
  }
}
        ...
        <div class="row">
          <div class="col-12">
            ...
            <div class="card">
              ...
              <div class="card-body">
                <table id="tableLocal" class="table table-bordered table-striped">
                  <thead>
                    <tr>
                      <th>Nome</th>
                    </tr>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-body">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" id = "form" method="post" action="local.php">
...
<!-- page script -->
<script>
document.querySelector("#tableLocal").addEventListener("dblclick", function(event){
...
<script>
  ...
  function clearForm(){
    ...
    document.querySelector('#titulo').innerText = 'Novo Local';
